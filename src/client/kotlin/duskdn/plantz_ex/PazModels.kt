...
import duskdn.plantz_ex.model.FlagBlockModel
import duskdn.plantz_ex.model.GnomeArmorModel
import duskdn.plantz_ex.model.GnomeModel
import duskdn.plantz_ex.model.plants.*
import duskdn.plantz_ex.model.projectiles.*
import duskdn.plantz_ex.model.zombies.*
import duskdn.plantz_ex.model.zombies.init.PazZombieModel
import duskdn.plantz_ex.util.pazResource
import duskdn.plantz_ex.renderer.entity.BalloonRenderer
import duskdn.plantz_ex.renderer.entity.GnomeRenderer
import duskdn.plantz_ex.renderer.entity.PazZombieRenderer
import duskdn.plantz_ex.renderer.PlantPotMinecartRenderer
import duskdn.plantz_ex.renderer.block.FlagRenderState
import duskdn.plantz_ex.renderer.block.FlagRenderer
import duskdn.plantz_ex.renderer.block.SunBatteryRenderSate
import duskdn.plantz_ex.renderer.block.SunBatteryRenderer
import duskdn.plantz_ex.renderer.block.TimeMachineRenderSate
import duskdn.plantz_ex.renderer.block.TimeMachineRenderer
import duskdn.plantz_ex.renderer.entity.ProjectileRenderer
import duskdn.plantz_ex.renderer.entity.SunRenderer
import duskdn.plantz_ex.renderer.entity.PirateCaptainRenderer
import duskdn.plantz_ex.renderer.entity.PlantRenderer
import duskdn.plantz_ex.renderer.entity.RoboZombieRenderer
import duskdn.plantz_ex.renderer.entity.SuperBrainzRenderer
...
object PazModels {
    ...
    @JvmField
    val IS_HYPNOTIZED_KEY: RenderStateDataKey<Boolean> = RenderStateDataKey.create { "plantz_ex:hypnotized" }
    @JvmField
    val IS_FROZEN_KEY: RenderStateDataKey<Boolean> = RenderStateDataKey.create { "plantz_ex:frozen" }
    @JvmField
    val IS_CHILLED_KEY: RenderStateDataKey<Boolean> = RenderStateDataKey.create { "plantz_ex:chilled" }
    @JvmField
