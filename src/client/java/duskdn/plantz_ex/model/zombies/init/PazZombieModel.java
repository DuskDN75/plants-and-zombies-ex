package duskdn.plantz_ex.model.zombies.init;

import duskdn.plantz_ex.ai.ZombieState;
import duskdn.plantz_ex.animation.zombies.init.PazZombieAnimations;
...
public class PazZombieModel extends ZombieModel<@NotNull PazZombieRenderState> {
    ...
    protected final KeyframeAnimation initAnimation;
