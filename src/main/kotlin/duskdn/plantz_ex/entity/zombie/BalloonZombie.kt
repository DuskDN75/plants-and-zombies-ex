...
import duskdn.plantz_ex.util.trackVariable
import duskdn.plantz_ex.util.updateTrackers
...
class BalloonZombie(type: EntityType<out BalloonZombie> = PazEntities.BALLOON_ZOMBIE, level: Level) : PazZombie(type, level), IFloatingMob {
    ...
    companion object {
        ...
        fun checkBalloonZombieSpawnRules(
            ...
            if (pos.y < level.getHeight(Heightmap.Types.WORLD_SURFACE, pos)) return false
    ...
    override fun tick() {
        ...
        if (!level.isClientSide) {
            ...
            if (balloons.isEmpty() && !spawnedBalloons && !firstTick) {
                ...
                debugPrint("SPAWNED BALLOONS: $spawnedBalloons")
