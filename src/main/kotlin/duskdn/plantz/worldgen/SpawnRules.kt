...
object SpawnRules {
    ...
    val IS_DARK = SpawnRule { context ->
        return@SpawnRule context.level.getBrightness(LightLayer.SKY, context.pos) < 10 || context.level.getBrightness(LightLayer.BLOCK, context.pos) < 15 || context.level.level.isDarkOutside
    }
