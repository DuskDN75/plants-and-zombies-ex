...
import duskdn.plantz_ex.animation.plants.LilyPadAnimation;
...
public class LilyPadModel extends PazPlantModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(pazResource("lilypad"), "main");
	...
	public LilyPadModel(ModelPart root) {
		super(
				LilyPadAnimation.init.bake(root),
				LilyPadAnimation.idle.bake(root),
				null,
				LilyPadAnimation.sleep.bake(root),
				null,
				root
		);
