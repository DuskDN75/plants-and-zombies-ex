...
public class Plantern<T extends Plantern> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "plantern"), "main");
	...
	public Plantern(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = inverted.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, -4.0F, 0.0F, 7.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 3.4F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r7 = inverted.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(41, 49).addBox(0.0F, -4.0F, -3.5F, 0.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, 0.0F, -0.1F, 0.0F, 3.1416F, 0.0F));

		PartDefinition center = inverted.addOrReplaceChild("center", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r8 = center.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 52).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r9 = leaf.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(40, 13).addBox(-2.0F, -0.0038F, -1.4135F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r10 = leaf2.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.4514F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r11 = leaf3.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(40, 16).addBox(-1.5486F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r12 = leaf4.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(40, 13).addBox(-2.0F, -0.0038F, -1.4135F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r13 = leaf5.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.4514F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r14 = leaf6.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(40, 16).addBox(-1.5486F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r15 = leaf7.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(40, 13).addBox(-2.0F, -0.0038F, -1.4135F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r16 = leaf8.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.4514F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r17 = leaf9.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(40, 16).addBox(-1.5486F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r18 = leaf10.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(40, 13).addBox(-2.0F, -0.0038F, -1.4135F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r19 = leaf11.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.4514F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r20 = leaf12.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(40, 16).addBox(-1.5486F, -0.0215F, -1.3826F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -0.2047F, 0.4933F, 0.0F, -1.5708F, 3.1416F));
		...
		PartDefinition cube_r21 = edge2.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(40, 39).mirror().addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.5F, -1.0F, -3.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r22 = edge2.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(40, 39).mirror().addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.5F, 3.0F, -2.5F, 0.0F, 1.5708F, 0.0F));

		PartDefinition edge3 = edges.addOrReplaceChild("edge3", CubeListBuilder.create(), PartPose.offset(-7.0F, 0.0F, 0.0F));

		PartDefinition cube_r23 = edge3.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(40, 39).addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, -1.0F, -3.5F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r24 = edge3.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(40, 39).addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 3.0F, -2.5F, 0.0F, -1.5708F, 0.0F));
		...
		PartDefinition cube_r25 = roots.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(28, 39).addBox(0.0F, -6.0F, -6.0F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 0.0F, 2.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r26 = roots.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(28, 39).addBox(0.0F, -6.0F, -4.0F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, 2.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r27 = roots.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(28, 39).addBox(0.0F, -6.0F, -4.0F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 6.0F, 0.0F, 3.1416F, 0.0F));

		return LayerDefinition.create(meshdefinition, 64, 64);
	}

	@Override
	public void setupAnim(Plantern entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
