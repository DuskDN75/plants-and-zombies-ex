package duskdn.plantz.model.plants;// Made with Blockbench 5.1.4
// Exported for Minecraft version 1.17 or later with Mojang mappings
// Paste this class into your mod and generate all required imports


import duskdn.plantz.PlantRenderState;
import duskdn.plantz.animation.plants.LavaLilyAnimation;
import duskdn.plantz.animation.plants.LilyPadAnimation;
...
public class LavaLilyModel extends PazPlantModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(pazResource("lavalily"), "main");
	...
	public LavaLilyModel(ModelPart root) {
		super(
				LavaLilyAnimation.init.bake(root),
				LavaLilyAnimation.idle.bake(root),
				null,
				LavaLilyAnimation.sleep.bake(root),
				null,
				root
		);
		...
		this.wall = this.head.getChild("wall");
		...
		this.floor = this.head.getChild("floor");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = stem.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 54).mirror().addBox(-3.0F, -2.0F, 0.0F, 6.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r2 = stem.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 54).addBox(-3.0F, -2.0F, 0.0F, 6.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition wall = head.addOrReplaceChild("wall", CubeListBuilder.create().texOffs(42, 13).addBox(-1.0F, -2.0F, -3.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 41).addBox(0.0F, -2.0F, -3.0F, 0.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		...
		PartDefinition eyes = wall.addOrReplaceChild("eyes", CubeListBuilder.create(), PartPose.offset(-5.6667F, -1.0F, 5.0F));

		PartDefinition rightEye = eyes.addOrReplaceChild("rightEye", CubeListBuilder.create().texOffs(43, 45).mirror().addBox(-2.0F, -2.0F, 5.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(3.6667F, 0.0F, -5.0F));

		PartDefinition eyebrows = eyes.addOrReplaceChild("eyebrows", CubeListBuilder.create(), PartPose.offset(2.6667F, 0.0F, -5.0F));
		...
		PartDefinition leftEye = eyes.addOrReplaceChild("leftEye", CubeListBuilder.create().texOffs(43, 45).addBox(-1.0F, -2.0F, 5.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.3333F, 0.0F, -5.0F));

		PartDefinition flower = head.addOrReplaceChild("flower", CubeListBuilder.create(), PartPose.offset(-4.7873F, -1.8887F, -1.9252F));

		PartDefinition cube_r3 = flower.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(38, 58).addBox(0.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0373F, 0.8887F, -0.0748F, -2.4848F, 0.8934F, -1.0299F));

		PartDefinition cube_r4 = flower.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(38, 58).mirror().addBox(-4.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0373F, 0.8887F, -0.0748F, -0.6254F, 0.8584F, 1.0706F));

		PartDefinition cube_r5 = flower.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(38, 58).mirror().addBox(-4.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0373F, 0.8887F, -0.0748F, -1.8041F, -0.3189F, 0.6485F));

		PartDefinition cube_r6 = flower.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(38, 58).addBox(0.0F, -2.5F, 0.0F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0373F, 0.8887F, -0.0748F, -1.3518F, -0.3286F, -0.6037F));

		PartDefinition center = flower.addOrReplaceChild("center", CubeListBuilder.create(), PartPose.offset(7.2873F, 5.8887F, -6.1747F));

		PartDefinition cube_r7 = center.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(37, 54).mirror().addBox(0.15F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.25F, -5.0F, 6.1F, -1.9638F, -0.0403F, -1.5541F));

		PartDefinition cube_r8 = center.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(37, 54).mirror().addBox(0.15F, -1.5F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.25F, -5.0F, 6.1F, 2.7486F, -0.0403F, -1.5541F));

		PartDefinition floor = head.addOrReplaceChild("floor", CubeListBuilder.create().texOffs(26, 39).addBox(12.0F, -1.0F, -3.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
	...
	public void setupAnim(@NotNull PlantRenderState state) {
		...
		this.body.yRot = state.yRot * (float) (Math.PI / 180.0) + (float) Math.PI;
		this.eyes.xRot = -state.xRot * (float) (Math.PI / 180.0);
	}
}