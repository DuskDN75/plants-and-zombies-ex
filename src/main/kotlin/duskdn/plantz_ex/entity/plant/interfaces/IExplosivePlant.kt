...
import duskdn.plantz_ex.ai.goal.ExplodeGoal.Companion.DESTRUCTIVE_EXPLOSION_CALCULATOR
import duskdn.plantz_ex.ai.goal.ExplodeGoal.Companion.EXPLOSION_CALCULATOR
import duskdn.plantz_ex.entity.plant.init.PazPlant
import duskdn.plantz_ex.entity.plant.init.PazPlant.Companion.SWELL
import duskdn.plantz_ex.entity.plant.init.PazPlant.Companion.SWELL_OLD
                ...
                if (entity.cooldown<0) {
                    if (entity.isAsleep) {
                        player.sendOverlayMessage(
                            Component.translatable("message.plantz_ex.sleeping", entity.name.copy().withStyle(
