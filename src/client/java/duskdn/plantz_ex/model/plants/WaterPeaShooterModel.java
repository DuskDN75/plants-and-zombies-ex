...
import duskdn.plantz_ex.animation.plants.WaterPeaAnimation;
...
public class WaterPeaShooterModel extends PazPlantModel {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(pazResource("water_peashooter"), "main");
