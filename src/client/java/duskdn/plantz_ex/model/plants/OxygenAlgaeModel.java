...
import duskdn.plantz_ex.animation.plants.SunflowerAnimation;
...
public class OxygenAlgaeModel extends PazPlantModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(pazResource("oxygen_algae"), "main");
	...
	public OxygenAlgaeModel(ModelPart root) {
		super(
