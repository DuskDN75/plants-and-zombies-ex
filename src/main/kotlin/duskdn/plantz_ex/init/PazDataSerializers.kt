...
object PazDataSerializers {
    ...
    @JvmField val DATA_BLINKTIMER = EntityDataSerializer.forValueType<Int>(ByteBufCodecs.VAR_INT)
    ...
    fun initialize() {
        ...
        FabricEntityDataRegistry.register(pazResource("blink_timer"), DATA_BLINKTIMER)
