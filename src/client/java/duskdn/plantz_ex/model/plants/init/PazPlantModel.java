package duskdn.plantz_ex.model.plants.init;

import duskdn.plantz_ex.renderer.entity.PlantRenderState;
import duskdn.plantz_ex.ai.PlantState;
import duskdn.plantz_ex.animation.plants.init.PazPlantAnimations;
 ...
 * @author Josh
 */
public class PazPlantModel extends EntityModel<@NotNull PlantRenderState> {
