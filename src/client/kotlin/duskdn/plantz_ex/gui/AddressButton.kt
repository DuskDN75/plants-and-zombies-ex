...
class AddressButton(
    ...
    val posText: MutableComponent =
        Component.literal("■").withColor(mailboxData.color)
            ...
            .append(Component.translatable("container.plantz_ex.mailbox_coords", mailboxData.blockPos.x, mailboxData.blockPos.y, mailboxData.blockPos.z).withColor(0xFFFFFFF))
