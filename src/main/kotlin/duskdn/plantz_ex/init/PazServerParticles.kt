...
object PazServerParticles {
    @JvmField val EMPTY: SimpleParticleType = registerSimple("empty")
    ...
    @JvmField val WATER_PEA_HIT: SimpleParticleType = registerSimple("pea_water")
    ...
    @JvmField val ENLIGHTENED: SimpleParticleType = registerSimple("enlightened")
