package duskdn.plantz_ex.entity

import duskdn.plantz_ex.init.PazBlocks
import duskdn.plantz_ex.init.PazBlocks.SUN_BATTERY_POI
...
import duskdn.plantz_ex.util.hasSpaceForSun
import duskdn.plantz_ex.util.tryAddSunToStorage
...
class Sun(type: EntityType<out Sun>, level: Level) : Entity(type, level), ILuminousEntity {
