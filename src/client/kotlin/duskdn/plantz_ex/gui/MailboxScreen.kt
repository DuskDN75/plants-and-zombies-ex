...
class MailboxScreen(
    ...
    fun initSearchBar(x: Int, y: Int): EditBox {
        val txt = EditBox(font, x, y, 94, 12, Component.translatable("container.plantz_ex.address_search"));
    ...
    override fun extractBackground(graphics: GuiGraphicsExtractor, xm: Int, ym: Int, a: Float) {
        ...
        if (addressButtons.isEmpty()) graphics.textWithWordWrap(font, Component.translatable("container.plantz_ex.no_address"), xo+52, yo+28, 96, -1)
    }
