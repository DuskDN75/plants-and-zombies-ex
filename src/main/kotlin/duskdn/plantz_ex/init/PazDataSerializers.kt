...
import duskdn.plantz_ex.entity.gnome.GnomeSoundVariant
import duskdn.plantz_ex.entity.gnome.GnomeVariant
import duskdn.plantz_ex.entity.zombie.BrownCoatVariant
import duskdn.plantz_ex.entity.zombie.ImpVariant
import duskdn.plantz_ex.entity.zombie.SuperBrainzVariant
...
object PazDataSerializers {
    ...
    @JvmField val DATA_ENLIGHTENED = EntityDataSerializer.forValueType<Boolean>(ByteBufCodecs.BOOL)
    @JvmField val DATA_ACTIVE = EntityDataSerializer.forValueType<Boolean>(ByteBufCodecs.BOOL)
    @JvmField val DATA_RECEIVING_AIR = EntityDataSerializer.forValueType<Boolean>(ByteBufCodecs.BOOL)
    ...
    fun initialize() {
        ...
        FabricEntityDataRegistry.register(pazResource("receiving_air"), DATA_RECEIVING_AIR)
        FabricEntityDataRegistry.register(pazResource("enlightened"), DATA_ENLIGHTENED)
